        ...
        const recipes = [
            {
                ...
                ingredients: [
                    ...
                    { item: "돼지고기", quantity: 200, unit: "g", prep: "한입 크기로 자르기" },
            ...
            },
            {
                ...
                { item: "상추 또는 양배추", quantity: "적당량", unit: "", prep: "씻어서 채썰기" },
            ...
            },
            {
                ...
                ingredients: [
                { item: "삶은 고구마", quantity: 1, unit: "개", prep: "껍질 벗기고 으깨기" },
            ...
            },
            {
                ...
                { item: "계란", quantity: "1", unit: "개", prep: "삶아서 반 갈라 토핑, 선택" }
                ],
                steps: [
            ...
            },
            {
                ...
                categories: ["국", "한식"],
                ingredients: [
                { item: "건미역", quantity: 10, unit: "g", prep: "찬물에 10분간 불린 후 자르기" },
                { item: "소고기 (국거리용)", quantity: 100, unit: "g", prep: "핏물 제거 후 한 입 크기로 썰기" },
            ...
            },
            {
                ...
                ingredients: [
                { item: "떡볶이 떡", quantity: 200, unit: "g", prep: "냉동 떡이면 찬물에 10분 해동" },
                ...
                { item: "고춧가루", quantity: 1, unit: "큰술", prep: "선택, 매운맛 조절" },
            ...
            },
            {
                ...
                time: "10분",
                method: "끓이기",
                image: "https://i.namu.wiki/i/IB40CpAHVmMzNLzboWyxLi6ETfuC1XXFzxR-ScNJGkyrvJPOCE0QJH5SQzHYHi3I4UNZCykFIUGPOuPvCd6OEw.webp",
            ...
            },
            {
                ...
                categories: ["두부요리"],
                ingredients: [
                { item: "부침용 두부", quantity: 1, unit: "모", prep: "물기 제거 후 으깨기" },
            ...
            },
            {
                ...
                time: "15분",
                method: "볶음",
                image: "https://static.wtable.co.kr/image-resize/production/service/recipe/1409/4x3/c08ac178-1062-42c6-ac5e-54443f8492a3.jpg",
                categories: ["면 요리", "초간단 요리"],
                ingredients: [
                { item: "냉동 우동사리", quantity: 1, unit: "인분", prep: "끓는 물에 데치기" },
                { item: "대파", quantity: 0.5, unit: "대", prep: "송송 썰기" },
        ...
        function displayRecipe(index) {
            ...
            filteredRecipeIndices.forEach((ri, idx) => {
                selectorHTML += `<option value="${ri}" ${ri == index ? "selected" : ""}>${recipes[ri].title}</option>`;
            });
            selectorHTML += `</select>`;
            ...
            document.querySelector(".recipe-header").innerHTML = `
                ${selectorHTML}
                <img src="${recipe.image}" alt="${recipe.title}" style="width:100%; border-radius:8px; margin:1em 0;">
                <p><strong>소요시간:</strong> ${recipe.time}</p>
                <p><strong>요리법:</strong> ${recipe.method}</p>
                <p><strong>카테고리:</strong> ${recipe.categories.join(", ")}</p>
            `;
            ...
            recipe.steps.forEach((step, i) => {
                ...
                div.id = `step${i + 1}`;
                div.innerHTML = `
                    <input type="checkbox" class="step-checkbox" onchange="toggleStep(${i + 1}, this)">
        ...
        function updateIngredientAmounts() {
            ...
            amounts.forEach((el, i) => {
                const newAmount = (baseAmounts[i] * (currentServing / recipe.servings)).toFixed(2);
        ...
        function logRecipeClick(recipe) {
            fetch("https://script.google.com/macros/s/AKfycbzdyXZcnRNwfOU9DYjsKzcCCJufl_mTrnrQkfEEMn0PF9y-4ipR7jlWqNjfBhW2lAQv/exec", {
                method: "POST",
                headers: {
                ...
                body: JSON.stringify({
                    ...
                    clickedFrom: selectedCategory || "전체"
                })
            })
            .then(res => res.json())
